...
- `/drone/gripper/magnet` - Publish to this topic to energize (`true`) or de-energize (`false`) the magnet. Message type: `std_msgs/msg/Bool`

- `/drone/gripper/attached` - Subscribe to this topic to know whether a box is currently attached to the magnet. Message type: `std_msgs/msg/Bool`
