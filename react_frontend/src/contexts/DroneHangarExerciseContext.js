...
const DroneHangarExerciseContext = createContext();

export function ExerciseProvider({ children }) {
  const exercise = "drone_hangar";
  ...
  const [filename, setFilename] = useState("drone-hangar");
...
while True:
  ...
  return (
    <DroneHangarExerciseContext.Provider
      value={{
        editorCode,
        openLoadModal,
        connectionState,
...
export default DroneHangarExerciseContext;
