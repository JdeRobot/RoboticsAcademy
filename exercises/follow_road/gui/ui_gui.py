...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.takeoffButton.setGeometry(QtCore.QRect(480, 30, 161, 41))
        ...
        self.pushButton.setGeometry(QtCore.QRect(480, 85, 161, 41))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/images/play.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton.setIcon(icon)
        self.pushButton.setObjectName("playButton")
        ...
        self.resetButton.setGeometry(QtCore.QRect(480, 140, 161, 41))
        ...
        self.imageVentral = QtWidgets.QLabel(self.layoutWidget)
        self.imageVentral.setObjectName("imageVentral")
        self.gridLayout.addWidget(self.imageVentral, 1, 1, 1, 1)
        self.imageFilteredVentral = QtWidgets.QLabel(self.layoutWidget)
        self.imageFilteredVentral.setText("")
        self.imageFilteredVentral.setObjectName("imageFiltered")
        self.gridLayout.addWidget(self.imageFilteredVentral, 2, 1, 1, 1)
        self.imageFrontal = QtWidgets.QLabel(self.layoutWidget)
        self.imageFrontal.setObjectName("imageFrontal")
        self.gridLayout.addWidget(self.imageFrontal, 1, 0, 1, 1)
        self.imageFilteredFrontal = QtWidgets.QLabel(self.layoutWidget)
        self.imageFilteredFrontal.setText("")
        self.gridLayout.addWidget(self.imageFilteredFrontal, 2, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.imageVentral.setText(_translate("MainWindow", "TextLabel"))
        self.imageFrontal.setText(_translate("MainWindow", "TextLabel"))
