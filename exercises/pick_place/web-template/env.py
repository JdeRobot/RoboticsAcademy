...
class ENV():
    ...
    def spawn_all_model(self):
        ...
        with open(filename) as file:
            ...
            robot_x = self.objects_info["robot"]["pose"]["x"]
            robot_y = self.objects_info["robot"]["pose"]["y"]
            robot_z = self.objects_info["robot"]["pose"]["z"]
            robot_roll = self.objects_info["robot"]["pose"]["roll"]
            robot_pitch = self.objects_info["robot"]["pose"]["pitch"]
            robot_yaw = self.objects_info["robot"]["pose"]["yaw"]

            rospy.loginfo("Spawning Objects in Gazebo and planning scene")
            objects = self.objects_info["objects"]
            ...
            obstacles = self.objects_info["obstacles"]
