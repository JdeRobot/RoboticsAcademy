...
instructions = {
    "follow_line": {
        ...
        "instructions_host": "python /RoboticsAcademy/exercises/follow_line/web-template/host.py " + ip_address
    },
    "obstacle_avoidance": {
        ...
        "instructions_host": "python /RoboticsAcademy/exercises/obstacle_avoidance/web-template/host.py " + ip_address
    },
