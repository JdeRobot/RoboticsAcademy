...
| Palletizing with industrial robot    |        ok        |     ok      |      ok       |    ok    | -                                 | -                            |         ok         |      reset failure      |
...
| Drone Visual Lander                  |        ok        |     ok      |       ok      |    ok    | -                                 | -                            |         ok         | missing actor collision |
| Drone Cat and Mouse                  |        ok        |     ok      |       ok      |    ok    | -                                 | -                            |         ok         |                         |
|                                      |                  |             |               |          |                                   |                              |                    |                         |
