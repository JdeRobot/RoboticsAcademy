...
class Launch(Tests):
    ...
    def main(self):
        try:
            args = ['/opt/ros/noetic/bin/roslaunch', '/RoboticsAcademy/exercises/follow_turtlebot/web-template/launch/gazebo.launch', '--wait']
            ...
            args = ['/opt/ros/noetic/bin/roslaunch', '/RoboticsAcademy/exercises/follow_turtlebot/web-template/launch/px4.launch']
            if ACCELERATION_ENABLED: args.insert(0, 'vglrun')
            subprocess.Popen(args, stdout=subprocess.PIPE)
            ...
            args = ['/opt/ros/noetic/bin/roslaunch', '/RoboticsAcademy/exercises/follow_turtlebot/web-template/launch/mavros_and_turtlebot.launch']
            if ACCELERATION_ENABLED: args.insert(0, 'vglrun')
            subprocess.Popen(args, stdout=subprocess.PIPE)
