...
from manager.libs.applications.compatibility.exercise_wrapper import (
    CompatibilityExerciseWrapper,
)
...
class Exercise(CompatibilityExerciseWrapper):
    def __init__(self, circuit: str, update_callback: Callable):
        ...
        super(Exercise, self).__init__(
            exercise_command=f"{current_path}/../python_template/ros1_noetic/exercise.py 0.0.0.0",
