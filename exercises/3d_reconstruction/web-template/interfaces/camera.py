...
class ListenerParameters:
    def __init__(self, configFile, cam):
        ...
        self.K = np.array(
            [data["K"][0], data["K"][1], data["K"][2], data["K"][4], data["K"][5], data["K"][6], data["K"][8],
             data["K"][9], data["K"][10]], dtype=np.double).reshape(3, 3)
        self.RT = np.array(
            [data["RT"][0], data["RT"][1], data["RT"][2], data["RT"][3], data["RT"][4], data["RT"][5], data["RT"][6],
             data["RT"][7], data["RT"][8], data["RT"][9], data["RT"][10], data["RT"][11], 0, 0, 0, 1],
    ...
    def project(self, point3d):
        point3d[3] = -1.0
        a1 = self.RT[0, 0] * point3d[0] + self.RT[0, 1] * point3d[1] + self.RT[0, 2] * point3d[2] + self.RT[0, 3] * \
             point3d[3]
        a2 = self.RT[1, 0] * point3d[0] + self.RT[1, 1] * point3d[1] + self.RT[1, 2] * point3d[2] + self.RT[1, 3] * \
             point3d[3]
        a3 = self.RT[2, 0] * point3d[0] + self.RT[2, 1] * point3d[1] + self.RT[2, 2] * point3d[2] + self.RT[2, 3] * \
             point3d[3]
        a4 = self.RT[3, 0] * point3d[0] + self.RT[3, 1] * point3d[1] + self.RT[3, 2] * point3d[2] + self.RT[3, 3] * \
             point3d[3]
