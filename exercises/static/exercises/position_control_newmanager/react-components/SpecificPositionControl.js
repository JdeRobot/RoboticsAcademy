...
import { drawImage, drawLeftImage} from "./helpers/showImagesPositionControl";


function SpecificPositionControl(props) {
...
SpecificPositionControl.propTypes = {
  circuit: PropTypes.string,
};

export default SpecificPositionControl
