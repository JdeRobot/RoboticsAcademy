...
const FollowRoadExerciseContext = createContext();

export function ExerciseProvider({ children }) {
  const exercise = "follow_road";
  ...
  const [filename, setFilename] = useState("follow-road");
...
while True:
  ...
  return (
    <FollowRoadExerciseContext.Provider
      value={{
        editorCode,
        openLoadModal,
        connectionState,
...
export default FollowRoadExerciseContext;
