...
// - SimTimeNode links to "common_interfaces_cpp/hal/sim_time.hpp"
class MotorsNode;
class OdometryNode;
class LaserNode;
class SimTimeNode;
...
public:
    ...
    static double get_sim_time();
    static LaserData get_laser_data();
    static void lift();
    static void putdown();
    static bool get_lift_state();
