...
import {updatePath, addToPath} from "./helpers/O3DEDemoHelper";
...
export default function SpecificO3DEDemo() {
        ...
        {path &&
          <svg height="100%" width="100%" xmlns="http://www.w3.org/2000/svg" style={{zIndex:2, position:"absolute"}}>
            <path xmlns="http://www.w3.org/2000/svg" d={path} 
              style={{strokeWidth: "30px", strokeLinejoin:"round", stroke: "white", fill: "none"}}
            />
          </svg>
        }
      </div>
