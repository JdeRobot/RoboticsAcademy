...
import { drawImage, drawLeftImage} from "./helpers/showImagesLabyrinthEscape";


function SpecificLabyrinthEscape(props) {
...
SpecificLabyrinthEscape.propTypes = {
  circuit: PropTypes.string,
};

export default SpecificLabyrinthEscape
