...
import { draw, clearMap } from "../helpers/VacuumCleaner/BirdEye";
...
const VacuumCleanerExerciseContext = createContext();

export function ExerciseProvider({ children }) {
  const exercise = "vacuum_cleaner";
  const exerciseSpecificCSS = "vacuum-eye";
...
while True:
  ...
  return (
    <VacuumCleanerExerciseContext.Provider
      value={{
        editorCode,
        openLoadModal,
        connectionState,
...
export default VacuumCleanerExerciseContext;
