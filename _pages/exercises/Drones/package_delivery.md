...
- It is recommended to use the latest image. However, older distributions of RARoboticsBackendDI can be found [here](https://hub.docker.com/r/jderobot/robotics-backend/tags).
