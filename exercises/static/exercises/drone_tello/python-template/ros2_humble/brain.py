...
class BrainProcess(multiprocessing.Process):
    ...
    def generate_modules(self):
        ...
        hal_module.HAL.turn_right = self.hal.turn_right
        hal_module.HAL.turn_left = self.hal.turn_left
        hal_module.HAL.up = self.hal.up
        hal_module.HAL.left = self.hal.left
        hal_module.HAL.right = self.hal.right
        hal_module.HAL.forward = self.hal.forward
        hal_module.HAL.back = self.hal.back
        
        
        hal_module.HAL.setVX = self.hal.sendVX
        hal_module.HAL.setVY = self.hal.sendVY
        hal_module.HAL.setVZ = self.hal.sendVZ
        hal_module.HAL.setW = self.hal.sendW
        hal_module.HAL.setVelocities = self.hal.sendVelocities
