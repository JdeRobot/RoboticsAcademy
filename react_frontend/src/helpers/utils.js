export const get_inner_size = (element) => {
    ...
    let width = element.offsetWidth - padding_x - border_x;
    let height = element.offsetHeight - padding_y - border_y;
...
export const saveCodeUnibotics = (exercise, verbose = true) => {
