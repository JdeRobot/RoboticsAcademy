  ...
  _position_control: {
    hal: [
      ...
      },
      {
        ...
        label: "init_beacons()",
        code: "init_beacons()",
        docstring: "Initializes the beacon route.",
      },
      {
        type: "method",
        label: "get_next_beacon()",
        code: "get_next_beacon()",
        docstring:
          "Returns the next unreached beacon (or None if the route is complete). Beacon objects expose get_pose(), get_id(), is_reached(), set_reached(value), is_active() and set_active(value).",
      },
    ],
    webgui: [
      {
