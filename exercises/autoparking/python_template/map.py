...
class Map:
    ...
    def setLaserValues(self):
        ...
        lasers = [
            self.setSingleLaserValue(self.laser_f),
            self.setSingleLaserValue(self.laser_r),
            self.setSingleLaserValue(self.laser_b),
        ]
        ranges = [
            20 * self.laser_f.maxRange,
            20 * self.laser_r.maxRange,
            20 * self.laser_b.maxRange,
        ]
