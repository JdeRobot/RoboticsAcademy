...
if __name__ == "__main__":
    ...
    # ------------ M O T O R S ----------------------------------
    print("Publishing "+  "VacuumSLAM.Motors" + " with ROS messages")
    topicM = cfg.getProperty("VacuumSLAM.Motors"+".Topic")
    maxW = cfg.getPropertyWithDefault("VacuumSLAM.Motors"+".maxW", 0.5)
    if not maxW:
        maxW = 0.5
        print ("VacuumSLAM.Motors"+".maxW not provided, the default value is used: "+ repr(maxW))
    maxV = cfg.getPropertyWithDefault("VacuumSLAM.Motors"+".maxV", 5)
    if not maxV:
        maxV = 5
        print ("VacuumSLAM.Motors"+".maxV not provided, the default value is used: "+ repr(maxV))
    ...
    # -------- L A S E R --------------------------------------------------
    print("Receiving " + "VacuumSLAM.Laser" + "  LaserData from ROS messages")
    topicL  = cfg.getProperty("VacuumSLAM.Laser"+".Topic")
    laser = ListenerLaser(topicL)
    # -------- B U M P E R --------------------------------------------------
    print("Receiving " + "VacuumSLAM.Bumper" + " from ROS messages")
    topicB = cfg.getProperty("VacuumSLAM.Bumper"+".Topic")
