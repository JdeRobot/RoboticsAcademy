...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.colorFilter = QtWidgets.QCheckBox(self.centralwidget)
        self.colorFilter.setGeometry(QtCore.QRect(590, 480, 111, 22))
        self.colorFilter.setObjectName("colorFilter")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.colorFilter.setText(_translate("MainWindow", "Color Filter"))
