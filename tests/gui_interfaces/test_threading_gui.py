...
class TestThreadingGUI(unittest.TestCase):
    ...
    def test_gui_in_thread_unsupported_message(self):
        ...
        with patch(
            "manager.ram_logging.log_manager.LogManager.logger.error"
        ) as mock_error:
    ...
    def test_send_to_client_exception(self):
        ...
        with patch(
            "manager.ram_logging.log_manager.LogManager.logger.info"
        ) as mock_info:
            self.gui.send_to_client("test_message")
    ...
    def test_start_method(self, mock_thread):
        ...
        thread_targets = [
            call_args[1]["target"] for call_args in mock_thread.call_args_list
        ]
