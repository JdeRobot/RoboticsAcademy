...
import {updatePath, addToTrail, updateTrail} from "./helpers/o3deWarehouseHelper";
...
function Specifico3deWarehouse(props) {
...
Specifico3deWarehouse.propTypes = {
  circuit: PropTypes.string,
};

export default Specifico3deWarehouse