...
- For Linux machines with NVIDIA GPUs, acceleration can be enabled by using NVIDIA proprietary drivers, installing  [VirtualGL](https://virtualgl.org/) and executing the following docker run command:
  ```bash
  docker run -it --rm --device /dev/dri  -p 8000:8000 -p 7681:7681 -p 2304:2304 -p 2303:2303 -p 1905:1905 -p 8765:8765 -p 1904:1904 -p 6080:6080 -p 1108:1108 jderobot/robotics-academy:latest ./start.sh
  ```
...
```bash
docker run -it --rm -v $HOME/.roboticsacademy:/logs --device /dev/dri -p 8000:8000 -p 7681:7681 -p 2304:2304 -p 2303:2303 -p 1905:1905 -p 8765:8765 -p 1904:1904 -p 6080:6080 -p 1108:1108 jderobot/robotics-academy:latest ./start_logs.sh
```
...
- Start a new docker container of the image and keep it running in the background ([hardware accelerated version](#enable-gpu-acceleration)/[store terminal output](#optional-store-terminal-output))
	...
	```bash
  docker run -it --rm -p 8000:8000 -p 7681:7681 -p 2304:2304 -p 2303:2303 -p 1905:1905 -p 8765:8765 -p 1904:1904 -p 6080:6080 -p 1108:1108 jderobot/robotics-academy:latest ./start.sh
  ```
