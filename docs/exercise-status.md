...
| Drone Rescue people                  |        ok        |     ok      |      ok       |          | [Docs][doc_drone_rescue_people]  | -                            |                   |         ok         |             |
| Drone Gymkhana                       |        ok        |     ok      |      ok       |          | [Docs][doc_drone_gymkhana]       | [Link][vid_drone_gymkhana]   |                   |         ok         |             |
| Drone Power tower Inspection         |        ok        |     ok      |      ok       |          | [Docs][doc_drone_inspection]     | -                            |                   |         ok         |             |
| Visual 3D reconstruction             |        ok        |     ok      |      ok       |          | [Docs][doc_3d_reconstruction]    | [Link][vid_3d_reconstr]      |        ok         |         ok         |             |
| DL e2e Visual control                |        ok        |     ok      |      ok       |          | [Docs][doc_dl_e2e_visual_control]| -                            |        ok         |         ok         |             |
| Basic Computer Vision                |        ok        |     ok      |      ok       |          | [Docs][doc_basic_comp_vision]    | [Link][vid_basic_cv]         |       none        |        none        |             |
| DL image classification              |        ok        |     ok      |      ok       |          | [Docs][doc_dl_classification]    | -                            |       none        |        none        |             |
| DL visual object detection           |        ok        |     ok      |      ok       |          | [Docs][doc_visual_obj_detection] | -                            |       none        |        none        |             |
| Pick and Place                       |        ok        |     ok      |      ok       |          | [Docs][doc_pick_and_place]       | [Link][vid_pick_place]       |        ok         |         ok         |             |
