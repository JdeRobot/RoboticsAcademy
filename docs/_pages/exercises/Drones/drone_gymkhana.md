...
gallery:
  - url: /assets/images/exercises/drone_gymkhana/drone_gymkhana.png
    image_path: /assets/images/exercises/drone_gymkhana/drone_gymkhana.png
    alt: "Drone Gymkhana."
    title: "Drone Gymkhana."
...
To goal of this exercise is to learn about the different drone controls. In addition, you will have contact with the drone infrastructure for the first time, which is important to master to face the rest of the exercises.
