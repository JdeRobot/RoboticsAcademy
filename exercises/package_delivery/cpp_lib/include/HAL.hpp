...
public:
    ...
    // Magnetic gripper (electromagnet)
    static void enable_magnet();
    static void disable_magnet();
    static bool is_carrying();
...
private:
    ...
    static std::shared_ptr<GripperNode> gripper_node_;
