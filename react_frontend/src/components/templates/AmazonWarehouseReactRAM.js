...
import RAMAmazonWarehouseExerciseView from "../views/RAM/RAMAmazonWarehouseExerciseView"; // same views as Follow Line
      ...
      <ViewProvider>
        <ExerciseProvider>
          ...
          <View
            ...
            exerciseId={
              <RAMAmazonWarehouseExerciseView context={NewManagerExerciseContext} />
            }
          />
          <Footer></Footer>
        </ExerciseProvider>
