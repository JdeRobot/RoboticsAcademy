...
- `HAL.setW(velocity)` - to set the angular speed.
...
- `HAL.getLiftState()` - Returns the current lift state (`True` if lifted).
...
- Convert the coordinates from meter to pixel before representing with _WebGUI.showPath(array)_.
