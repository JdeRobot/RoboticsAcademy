...
const FlexContainer = (props) => {
  ...
  const onMouseMove = (e) => {
    ...
    console.log(`Bounds: (${bounds.left}, ${bounds.top}) Client: (${e.clientX}, ${e.clientY}) Coordinates: (${x}, ${y})`);
  ...
  return (
    <div ref={containerRef} className={containerClass}>
      <div ref={firstChildRef} className={"flex-container-first"}>{props.children[0]}</div>
