...
class Launch(Tests):
    ...
    def main(self):
        try:
            args = ['/opt/ros/melodic/bin/roslaunch', '/RoboticsAcademy/exercises/follow_road/web-template/launch/gazebo.launch', '--wait']
            ...
            args = ['/opt/ros/melodic/bin/roslaunch', '/RoboticsAcademy/exercises/follow_road/web-template/launch/px4.launch']
            if ACCELERATION_ENABLED: args.insert(0, 'vglrun')
            subprocess.Popen(args, stdout=subprocess.PIPE)
            ...
            args = ['/opt/ros/melodic/bin/roslaunch', '/RoboticsAcademy/exercises/follow_road/web-template/launch/mavros.launch']
            if ACCELERATION_ENABLED: args.insert(0, 'vglrun')
            subprocess.Popen(args, stdout=subprocess.PIPE)
