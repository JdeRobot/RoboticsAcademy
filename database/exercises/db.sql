...
ALTER TABLE public.exercises_tools ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
	SEQUENCE NAME public.exercises_tools_id_seq
	START WITH 1
	INCREMENT BY 1
	NO MINVALUE
	NO MAXVALUE
...
18	digit_classification	Digit Classification	Deep learning-based Digit Classification.	{"tags": ["Computer Vision","Deep Learning","Classification"]}	ACTIVE	RoboticsAcademy/exercises/static/exercises/digit_classification/python_template/
19	human_detection	Human Detection	Deep learning-based human detection.	{"tags": ["Computer Vision","Deep Learning"]}	ACTIVE	RoboticsAcademy/exercises/static/exercises/human_detection/python_template/
20	drone_gymkhana	Drone Gymkhana	Drone Gymkhana	{"tags": ["ROS2","Drones"]}	ACTIVE	RoboticsAcademy/exercises/static/exercises/drone_gymkhana/python_template/
21	power_tower_inspection	Power Tower Inspection	Power Tower inspection using drones	{"tags": ["ROS2","Drones"]}	ACTIVE	RoboticsAcademy/exercises/static/exercises/power_tower_inspection/python_template/
\.
