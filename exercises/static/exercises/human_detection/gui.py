...
class GUI:
    ...
    def payloadImage(self):
        ...
        count_to_be_shown = self.count_to_be_shown
        self.image_show_lock.release()

        image = image_to_be_shown
        payload = {'image': '', 'shape': '', 'count': ''}
        ...
        payload['shape'] = shape
        payload['count'] = count_to_be_shown
    ...
    def showResult(self, image, count):
        self.image_show_lock.acquire()
        self.image_to_be_shown = image
        self.count_to_be_shown = count
