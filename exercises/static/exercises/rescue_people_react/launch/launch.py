...
class Launch():
    ...
    def start(self):
        ...
        args = ["/opt/ros/noetic/bin/roslaunch",
                "/RoboticsAcademy/exercises/" + EXERCISE + "/launch/gazebo.launch",
                "--wait",
                "--log"
                ]
        ...
        ######## LAUNCH PX4 ########
        args = ["/opt/ros/noetic/bin/roslaunch",
                "/RoboticsAcademy/exercises/" + EXERCISE + "/launch/px4.launch",
                "--log"
                ]
        ...
        ######## LAUNCH MAVROS ########
        args = ["/opt/ros/noetic/bin/roslaunch",
                "/RoboticsAcademy/exercises/" + EXERCISE + "/launch/mavros.launch",
                "--log"
                ]
