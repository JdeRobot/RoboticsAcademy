...
from shared.array import SharedArray
import numpy as np
import cv2
...
class HALFunctions:
    def __init__(self):
        ...
        self.shared_position = SharedArray("position")
        self.shared_velocity = SharedArray("velocity")
        self.shared_orientation = SharedArray("orientation")
