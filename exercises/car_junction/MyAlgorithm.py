...
# This Algorithm solution was developed by PabloMorenoVera.
# This file will be then replaced by MyAlgorithm_empty.py for learners
...
class MyAlgorithm(threading.Thread):
    ...
    def execute(self):
        ...
        print('STOP:            ', self.stopcar)



        # CAR DETECTION

        if self.stopcar == True and self.turning == False:
            # Getting the images
